var icons = document.querySelectorAll(".icon"),
    ...
    titleArr = [
      "Открытие <br> чемпионата <br> по шахматам",
      "Интерактивная <br> выставка <br> &laquoAcid Noodles&raquo",
      "Чилл-аут зона <br> &laquoApex&raquo ",
      "Оформление <br> званного <br> ужина &laquoVertu&raquo",
      "Видео-приглашение <br> &laquoNИ&raquo",
      "Промо-ролик для<br> ТЦ &laquoЦветной&raquo",
      "Мультимедийная выставка <br> &laquoЦифровые сны о России&raquo",
      "Многослойная <br> проекция <br> &laquoЦиклотрон&raquo",
      "Выставка-вечеринка <br> &laquoПритащи свой проектор&raquo",
      "Сценография для <br> танцевального шоу <br> &laquoTroyka&raquo",
      "Ролик для <br> &laquoArsenicum&raquo",
      "Ролик для <br> &laquoTurbo Yulia&raquo",
      "Сценография <br> &laquoSiemens &mdash; 160 лет в России&raquo",
      "Шоу запуска <br> лимитированной серии <br> &laquoWhite Jaguar&raquo",
      "Интерактивная <br> инсталляция <br> &laquoМ_СЛИ&raquo",
      "Капсульная коллекция <br> &laquoNINA DONIS&raquo"
    ];
